...
const webDevProcess = [
  {
    ...
    description:
      "We begin by understanding your business goals, audience, and technical needs.",
  },
  {
    step: "02",
    title: "UI/UX Design",
    description:
      "Our team focuses on modern website design that is intuitive, responsive, and conversion-driven.",
  },
  {
    step: "03",
    title: "Development",
    description:
      "As a trusted website development company in India, we build fast, scalable, and SEO-friendly websites.",
  },
  {
    step: "04",
    title: "Deployment & Optimization",
    description:
      "We launch your website with full testing, speed optimization, and performance tracking, because great website development services in India don’t stop at delivery.",
  },
];
...
export default function WebDevClient() {
  return (
    <section className="bg-black text-white overflow-hidden">
      <h1 className="sr-only absolute">Website Design and Development Services</h1>
      {/* Hero section */}
      <section className="relative pt-24 pb-20 lg:pb-32 overflow-hidden">
        ...
        <div className="relative z-10 flex justify-center text-center mx-auto px-6 pt-16 lg:pt-24">
          <div className="max-w-3xl">
            ...
            >
              From high-converting landing pages to full-scale websites, our web
              development services focus on performance, user experience, and
              growth, helping your business stand out and rank higher.
            </motion.p>
