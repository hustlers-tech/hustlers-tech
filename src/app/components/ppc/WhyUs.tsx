        ...
        >
          <span>
            ...
            <div className="why-us-image relative rounded-2xl overflow-hidden  group">
              <img src={"/services/ppc/ppc-strategy.jpg"} alt="Hustlers Tech development team" className="w-full h-full object-cover aspect-[4/3] transition-transform duration-1000 group-hover:scale-105" />
